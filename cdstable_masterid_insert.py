...
# CONFIG
# -----------------------------
main_file = "csv/vir/master/mstcds.csv"             # CSV where master_id must be added
mapping_file = "msteqpt_processed.csv"             # CSV containing master_id + Ledger_code
output_file = "csd_table_output_with_master_id.csv"
removed_file = "removed_empty_L_CODE_rows.csv"     # rows removed because L_CODE empty
unmatched_file = "unmatched_L_CODE_rows.csv"       # unmatched after merge (no master_id)
