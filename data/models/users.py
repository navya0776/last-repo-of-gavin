...
class RolePermissions(BaseModel):
    ...
    # You can extend this with more specific permissions as your application grows,
    # e.g., 'approve', 'export', 'admin_access'.
...
class User(BaseModel):
    ...
    username: str 
    password: str 
    # Using a list allows a user to have multiple roles if necessary.
    role:Role